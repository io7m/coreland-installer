...
phase_compile:\
	...
	buffer_put.o deinstaller.o error.o error_str.o fmt_uint.o \
	fmt_uinto.o fmt_ulong.o fmt_ulongo.o get_opt.o install.o installer.o \
	instchk.o insthier.o open_ro.o open_trunc.o str_chr.o str_diff.o \
...
phase_library:\
	bin.a buffer.a error.a fmt.a get_opt.a open.a str.a syserr.a 
phase_library_clean:
	rm -f bin.a buffer.a error.a fmt.a get_opt.a open.a str.a syserr.a 

#--LINK-----------------------------------------------------------------------

deinstaller:\
	link deinstaller.ld deinstaller.o install.o insthier.o open.a \
	syserr.a get_opt.a fmt.a buffer.a str.a bin.a error.a 
	./link deinstaller deinstaller.o install.o insthier.o open.a \
	syserr.a get_opt.a fmt.a buffer.a str.a bin.a error.a 
installer:\
	link installer.ld installer.o install.o insthier.o open.a syserr.a \
	get_opt.a fmt.a buffer.a str.a bin.a error.a 
	./link installer installer.o install.o insthier.o open.a syserr.a \
	get_opt.a fmt.a buffer.a str.a bin.a error.a 
instchk:\
	link instchk.ld instchk.o install.o insthier.o open.a syserr.a \
	get_opt.a fmt.a buffer.a str.a bin.a error.a 
	./link instchk instchk.o install.o insthier.o open.a syserr.a \
	get_opt.a fmt.a buffer.a str.a bin.a error.a 
